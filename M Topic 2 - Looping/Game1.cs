...
namespace M_Topic_2___Looping
{
    ...
    public class Game1 : Game
    {
        ...
        SoundEffect bugSquishEffect;
        SpriteFont introFont;
        Screen screen;
        Random random = new Random();
        int movementHelper, score;
        double timer = 10;
        ...
        protected override void LoadContent()
        {
            ...
            bugSquishEffect = Content.Load<SoundEffect>("bugsquish");
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (screen == Screen.Intro)
            {
                _spriteBatch.DrawString(introFont, "Bug Squisher\n\nClick to start...", new Vector2(100, 300), Color.White);
            }
            ...
            else if (screen == Screen.Game)
            {
                ...
                for (int i = 0; i < deadBugs.Count; i++)
                    _spriteBatch.Draw(deadBugTextures[i], deadBugs[i], Color.Red);
                for (int i = 0; i < bugs.Count; i++)
                ...
                _spriteBatch.DrawString(introFont, timer.ToString("0.00"), new Vector2(10, 10), Color.Black);
            }

            else if (screen == Screen.Death)
            {
                _spriteBatch.DrawString(introFont, $"You Died...\nYou had {score} points\nClick to retry...", new Vector2(100, 300), Color.White);
            }
